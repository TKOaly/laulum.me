	  ...
	  switch (action.type) {
	    case 'FETCH_SONGS':
	      return Object.assign({}, state, {
	        songs: (0, _reducer_songs2.default)(state.songs, action),
	        filteredSongs: (0, _reducer_songs2.default)(state.songs, action)
	      });
	    case 'SELECT_SONG':
	      return Object.assign({}, state, {
	        activeSong: (0, _reducer_active_song2.default)(state.activeSong, action)
	      });
	    case 'FILTER_SONGS':
	      return (0, _reducerFilterSongs2.default)(state, action);
	    default:
	      return state;
	  }
	};

	var _reducer_songs = __webpack_require__(269);

	var _reducer_songs2 = _interopRequireDefault(_reducer_songs);

	var _reducer_active_song = __webpack_require__(270);

	var _reducer_active_song2 = _interopRequireDefault(_reducer_active_song);

	var _reducerFilterSongs = __webpack_require__(271);

	var _reducerFilterSongs2 = _interopRequireDefault(_reducerFilterSongs);
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	    ...
	    return Object.assign({}, state, {
	        filteredSongs: state.songs.filter(function (song) {
	            return song.title.toLowerCase().indexOf(action.payload.toLowerCase()) != -1;
	        })
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _songList = __webpack_require__(295);

	var _songList2 = _interopRequireDefault(_songList);

	var _songDetail = __webpack_require__(296);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _songList2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'songs/:id', component: _songDetail2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRedux.connect)(null, { fetchSongs: _index.fetchSongs })(App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = function (_Component) {
	    ...
	    function SearchBar(props) {
	        ...
	        _this.state = _this.state || { searchterm: '' };
	        return _this;
	    }

	    _createClass(SearchBar, [{
	        key: 'onInputChange',
	        value: function onInputChange(searchterm) {
	...
	exports.default = (0, _reactRedux.connect)(null, { filterSongs: _index.filterSongs })(SearchBar);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FILTER_SONGS = exports.FETCH_SONGS = undefined;
	...
	var FILTER_SONGS = exports.FILTER_SONGS = 'FILTER_SONGS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isAbsoluteURL = __webpack_require__(291);
	var combineURLs = __webpack_require__(292);
	...
	axios.spread = __webpack_require__(294);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SongList = function (_Component) {
	  ...
	  _createClass(SongList, [{
	    ...
	    value: function renderList() {
	      if (!this.props.songs) return _react2.default.createElement(
	        'div',
	        null,
	        'Loading songs...'
	      );
	      return this.props.songs.map(function (song) {
	        return _react2.default.createElement(
	          _reactRouter.Link,
	          { to: "songs/" + song.key, key: song.title, className: 'col-md-4' },
	          _react2.default.createElement(
	            'div',
	            { className: 'song-card' },
	            song.title
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(SongList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backbutton = __webpack_require__(297);
	...
	var SongDetail = function (_Component) {
	  _inherits(SongDetail, _Component);
	  ...
	  _createClass(SongDetail, [{
	    ...
	    value: function render() {
	      ...
	      var song = this.props.songs.find(function (song) {
	        return song.key == _this2.props.params.id;
	      });
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(SongDetail);
